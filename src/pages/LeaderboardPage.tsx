                  ...
                  {entries.map((e) => {
                    ...
                    return (
                      ...
                      >
                          ...
                          <div className="flex min-w-0 items-center gap-1.5 sm:gap-2">
                            ...
                            <div className="min-w-0">
                              <div className="flex min-w-0 items-center gap-1">
                                <span className="truncate text-xs font-bold text-exchange-text sm:text-sm">
                                  {e.username}
                                </span>
                                {e.isAdmin ? (
                        ...
                        <td className="whitespace-nowrap px-2 py-2 text-right font-mono text-xs font-bold text-exchange-text sm:px-3 sm:py-2.5 sm:text-sm">
                        ...
                        <td className="px-2 py-2 sm:px-3 sm:py-2.5">
                          <div className="flex items-center justify-end gap-1.5 sm:gap-2">
                            <span className="h-1.5 w-8 shrink-0 overflow-hidden rounded-full bg-exchange-border/50 sm:h-1.5 sm:w-20">
                              <span
                                className="block h-full rounded-full bg-exchange-yellow"
                                style={{ width: `${Math.min(100, Math.max(0, e.score))}%` }}
                              />
                            </span>
                            <span className="w-8 shrink-0 text-right font-mono text-[10px] font-extrabold text-exchange-text sm:w-10 sm:text-xs">
